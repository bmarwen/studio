...
const EquipmentSlotDisplay = ({ slot, item, onUnequip }: { slot: EquipmentSlot, item: Item | null, onUnequip: (slot: EquipmentSlot) => void }) => {
    const ICONS: Record<EquipmentSlot, React.ReactNode> = {
        ...
        belt: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-muted-foreground opacity-75"><rect x="3" y="8" width="18" height="8" rx="2"></rect><path d="M8 12H5V9a3 3 0 0 1 3-3h0a3 3 0 0 1 3 3v3"></path></svg>,
    }
