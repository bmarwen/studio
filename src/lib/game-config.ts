...
export const ITEMS: Record<string, Omit<Item, 'id' | 'quantity' | 'itemId'>> = {
    ...
    // Rare
    'warrior_sword_rare_balanced': { name: 'Steel Longsword', type: 'weapon', rarity: 'Rare', attack: 12, defense: 2, description: 'A well-balanced and reliable steel sword.', icon: '/icons/item-sword.svg', allowedClasses: ['warrior'] },
    ...
    // Epic
    'warrior_sword_epic_balanced': { name: 'Flame Reaver', type: 'weapon', rarity: 'Epic', attack: 20, criticalChance: 5, magicResist: 5, description: 'A greatsword imbued with fire.', icon: '/icons/item-sword-fire.svg', allowedClasses: ['warrior'] },
    'warrior_sword_epic_crit': { name: 'Blade of the Whirlwind', type: 'weapon', rarity: 'Epic', attack: 16, criticalChance: 12, evasion: 4, description: 'So fast it creates its own gale.', icon: '/icons/item-sword.svg', allowedClasses: ['warrior'] },
    ...
    // Legendary
    'warrior_sword_legendary_balanced': { name: 'Dragon\'s Tooth', type: 'weapon', rarity: 'Legendary', attack: 35, defense: 5, criticalChance: 10, magicResist: 10, description: 'Carved from the fang of an ancient dragon.', icon: '/icons/item-sword.svg', allowedClasses: ['warrior'] },
    'warrior_sword_legendary_crit': { name: 'Soul-Render', type: 'weapon', rarity: 'Legendary', attack: 28, criticalChance: 20, evasion: 5, description: 'A blade that thirsts for critical strikes.', icon: '/icons/item-sword-fire.svg', allowedClasses: ['warrior'] },
    ...
    // Rare
    'mage_weapon_rare_balanced': { name: 'Staff of Power', type: 'weapon', rarity: 'Rare', magicAttack: 15, magicResist: 3, description: 'A staff crackling with magical energy.', icon: '/icons/item-staff.svg', allowedClasses: ['mage'] },
    ...
    // Epic
    'mage_weapon_epic_balanced': { name: 'Voidcaller Scepter', type: 'weapon', rarity: 'Epic', magicAttack: 25, magicResist: 5, description: 'A scepter that hums with the power of the void.', icon: '/icons/item-scepter.svg', allowedClasses: ['mage'] },
    ...
    'mage_weapon_epic_defensive': { name: 'Archmage\'s Greatstaff', type: 'weapon', rarity: 'Epic', magicAttack: 22, defense: 5, staminaBoost: 15, description: 'A conduit for immense magical flows.', icon: '/icons/item-staff.svg', allowedClasses: ['mage'] },
    // Legendary
    'mage_weapon_legendary_balanced': { name: 'Celestial Pillar', type: 'weapon', rarity: 'Legendary', magicAttack: 40, magicResist: 10, criticalChance: 10, description: 'A fragment of a fallen star.', icon: '/icons/item-staff.svg', allowedClasses: ['mage'] },
    ...
    'mage_weapon_legendary_defensive': { name: 'Heart of the Mana-Geyser', type: 'weapon', rarity: 'Legendary', magicAttack: 35, defense: 10, staminaBoost: 25, description: 'An endless wellspring of power.', icon: '/icons/item-scepter.svg', allowedClasses: ['mage'] },
    ...
    // Rare
    'ranger_weapon_rare_balanced': { name: 'Hunter\'s Crossbow', type: 'weapon', rarity: 'Rare', attack: 14, evasion: 2, criticalChance: 3, description: 'A precise and deadly crossbow for the skilled hunter.', icon: '/icons/item-crossbow.svg', allowedClasses: ['ranger'] },
    ...
    // Epic
    'ranger_weapon_epic_balanced': { name: 'Storm-Caller', type: 'weapon', rarity: 'Epic', attack: 22, evasion: 4, criticalChance: 5, description: 'A crossbow that fires bolts with the speed of lightning.', icon: '/icons/item-crossbow-electric.svg', allowedClasses: ['ranger'] },
    ...
    // Legendary
    'ranger_weapon_legendary_balanced': { name: 'Phoenix Wing', type: 'weapon', rarity: 'Legendary', attack: 38, evasion: 8, criticalChance: 12, description: 'Reborn in fire, shoots bolts of flame.', icon: '/icons/item-crossbow-electric.svg', allowedClasses: ['ranger'] },
    ...
    'ranger_weapon_legendary_heavy': { name: 'Ballista of the Colossus', type: 'weapon', rarity: 'Legendary', attack: 45, criticalChance: -15, armor: 10, description: 'More of a siege weapon than a crossbow.', icon: '/icons/item-crossbow.svg', allowedClasses: ['ranger'] },
    ...
    // Rare
    'assassin_weapon_rare_balanced': { name: 'Shadowfang Blade', type: 'weapon', rarity: 'Rare', attack: 10, criticalChance: 10, evasion: 2, description: 'A dagger coated in a fast-acting venom.', icon: '/icons/item-dagger.svg', allowedClasses: ['assassin'] },
    ...
    // Epic
    'assassin_weapon_epic_balanced': { name: 'Kingsbane', type: 'weapon', rarity: 'Epic', attack: 18, criticalChance: 15, evasion: 4, description: 'A legendary dagger said to have toppled thrones.', icon: '/icons/item-dagger-poison.svg', allowedClasses: ['assassin'] },
    ...
    // Legendary
    'assassin_weapon_legendary_balanced': { name: 'The Whisper', type: 'weapon', rarity: 'Legendary', attack: 32, criticalChance: 25, evasion: 10, description: 'They never hear it coming.', icon: '/icons/item-dagger.svg', allowedClasses: ['assassin'] },
    ...
    'blade_of_the_ancients': { name: 'Blade of the Ancients', type: 'weapon', rarity: 'Legendary', attack: 30, criticalChance: 10, defense: 10, description: 'A powerful blade pulsating with ancient magic. Can be wielded by any class.', icon: '/icons/item-sword.svg'},
    ...
    'warrior_armor_rare_balanced': { name: 'Steel Platebody', type: 'armor', rarity: 'Rare', defense: 8, armor: 12, description: 'Superb steel protection.', icon: '/icons/item-armor.svg', allowedClasses: ['warrior']},
    ...
    'warrior_armor_epic_offensive': { name: 'Gladiator\'s War-Plate', type: 'armor', rarity: 'Epic', defense: 10, armor: 15, attack: 8, criticalChance: 5, description: 'Adorned with symbols of victory.', icon: '/icons/item-armor.svg', allowedClasses: ['warrior']},
    ...
    'warrior_armor_legendary_offensive': { name: 'Armor of Unending Fury', type: 'armor', rarity: 'Legendary', defense: 16, armor: 22, attack: 15, criticalChance: 8, description: 'The more you are hit, the harder you strike.', icon: '/icons/item-armor.svg', allowedClasses: ['warrior']},
    ...
    'mage_armor_rare_balanced': { name: 'Sorcerer\'s Robes', type: 'armor', rarity: 'Rare', defense: 4, magicResist: 8, magicAttack: 4, description: 'Fine robes for a skilled spellcaster.', icon: '/icons/item-robe.svg', allowedClasses: ['mage']},
    ...
    'mage_armor_epic_balanced': { name: 'Archmage\'s Robes', type: 'armor', rarity: 'Epic', defense: 8, magicResist: 15, magicAttack: 10, description: 'Worn only by the most powerful mages.', icon: '/icons/item-robe.svg', allowedClasses: ['mage']},
    ...
    'mage_armor_legendary_balanced': { name: 'Celestial Raiment', type: 'armor', rarity: 'Legendary', defense: 14, magicResist: 25, magicAttack: 18, description: 'Woven from starlight itself.', icon: '/icons/item-robe.svg', allowedClasses: ['mage']},
    'mage_armor_legendary_offensive': { name: 'Robes of the Arcanist-God', type: 'armor', rarity: 'Legendary', defense: 10, magicResist: 15, magicAttack: 25, criticalChance: 10, description: 'Unleashes devastating power.', icon: '/icons/item-robe.svg', allowedClasses: ['mage']},
    ...
    'ranger_armor_rare_balanced': { name: 'Hunter\'s Leathers', type: 'armor', rarity: 'Rare', defense: 6, evasion: 6, criticalChance: 3, description: 'Perfect for tracking prey.', icon: '/icons/item-tunic.svg', allowedClasses: ['ranger']},
    ...
    'ranger_armor_epic_balanced': { name: 'Wild-Walker\'s Tunic', type: 'armor', rarity: 'Epic', defense: 10, evasion: 10, criticalChance: 7, description: 'Allows silent movement through any terrain.', icon: '/icons/item-tunic.svg', allowedClasses: ['ranger']},
    'ranger_armor_epic_offensive': { name: 'Armor of the Swift Arrow', type: 'armor', rarity: 'Epic', defense: 7, evasion: 8, criticalChance: 12, attack: 4, description: 'Makes your shots fly truer.', icon: '/icons/item-tunic.svg', allowedClasses: ['ranger']},
    ...
    'ranger_armor_legendary_balanced': { name: 'Dragon-Scale Vest', type: 'armor', rarity: 'Legendary', defense: 16, evasion: 15, criticalChance: 12, attack: 8, description: 'Light, flexible, and nearly impenetrable.', icon: '/icons/item-tunic.svg', allowedClasses: ['ranger']},
    'ranger_armor_legendary_offensive': { name: 'Mantle of the Eagle-Eye', type: 'armor', rarity: 'Legendary', defense: 12, evasion: 12, criticalChance: 20, attack: 10, description: 'You see all, and hit all.', icon: '/icons/item-tunic.svg', allowedClasses: ['ranger']},
    ...
    'assassin_armor_rare_balanced': { name: 'Nightshade Leathers', type: 'armor', rarity: 'Rare', defense: 5, evasion: 8, criticalChance: 7, description: 'Dyed with poisonous plants.', icon: '/icons/item-jerkin.svg', allowedClasses: ['assassin']},
    ...
    'assassin_armor_epic_balanced': { name: 'Silent Death Armor', type: 'armor', rarity: 'Epic', defense: 9, evasion: 12, criticalChance: 12, attack: 3, description: 'Your enemies never hear you coming.', icon: '/icons/item-jerkin.svg', allowedClasses: ['assassin']},
    'assassin_armor_epic_offensive': { name: 'Blade-Dancer\'s Tunic', type: 'armor', rarity: 'Epic', defense: 6, evasion: 10, criticalChance: 18, attack: 5, description: 'A whirlwind of death.', icon: '/icons/item-jerkin.svg', allowedClasses: ['assassin']},
    ...
    'assassin_armor_legendary_balanced': { name: 'Liars\'s Embrace', type: 'armor', rarity: 'Legendary', defense: 14, evasion: 18, criticalChance: 20, attack: 10, description: 'The perfect tool for a perfect betrayal.', icon: '/icons/item-jerkin.svg', allowedClasses: ['assassin']},
    'assassin_armor_legendary_offensive': { name: 'Vestments of the Faceless Man', type: 'armor', rarity: 'Legendary', defense: 10, evasion: 15, criticalChance: 30, attack: 12, description: 'Become no one.', icon: '/icons/item-jerkin.svg', allowedClasses: ['assassin']},
    ...
    'warrior_helmet_rare_offensive': { name: 'Vanguard\'s Helm', type: 'helmet', rarity: 'Rare', defense: 3, armor: 4, attack: 2, description: 'Lead the charge with this helm.', icon: '/icons/item-helmet.svg', allowedClasses: ['warrior']},
    ...
    'warrior_helmet_epic_balanced': { name: 'Champion\'s Helm', type: 'helmet', rarity: 'Epic', defense: 7, armor: 10, attack: 3, description: 'The helm of a true arena champion.', icon: '/icons/item-helmet.svg', allowedClasses: ['warrior']},
    ...
    'warrior_helmet_legendary_balanced': { name: 'Dragonbone Helm', type: 'helmet', rarity: 'Legendary', defense: 11, armor: 15, magicResist: 7, attack: 7, description: 'Crafted from a dragon\'s skull.', icon: '/icons/item-helmet.svg', allowedClasses: ['warrior']},
    'warrior_helmet_legendary_offensive': { name: 'Crown of the War-God', type: 'helmet', rarity: 'Legendary', defense: 8, armor: 10, attack: 10, criticalChance: 5, description: 'A symbol of ultimate martial power.', icon: '/icons/item-helmet.svg', allowedClasses: ['warrior']},
    ...
    'mage_helmet_rare_balanced': { name: 'Enchanter\'s Cowl', type: 'helmet', rarity: 'Rare', defense: 2, magicResist: 5, magicAttack: 3, description: 'Woven with threads of mana.', icon: '/icons/item-cowl.svg', allowedClasses: ['mage']},
    ...
    'mage_helmet_epic_balanced': { name: 'Cowl of the High Magus', type: 'helmet', rarity: 'Epic', defense: 4, magicResist: 10, magicAttack: 7, description: 'A sign of mastery over the elements.', icon: '/icons/item-cowl.svg', allowedClasses: ['mage']},
    ...
    'mage_helmet_legendary_balanced': { name: 'Third Eye of the Seer', type: 'helmet', rarity: 'Legendary', defense: 7, magicResist: 18, magicAttack: 12, criticalChance: 5, description: 'Sees all possibilities.', icon: '/icons/item-cowl.svg', allowedClasses: ['mage']},
    'mage_helmet_legendary_offensive': { name: 'Crown of the Storm-Lord', type: 'helmet', rarity: 'Legendary', defense: 5, magicResist: 12, magicAttack: 18, criticalChance: 8, description: 'Command the very heavens.', icon: '/icons/item-cowl.svg', allowedClasses: ['mage']},
    ...
    'ranger_helmet_rare_balanced': { name: 'Pathfinder\'s Hood', type: 'helmet', rarity: 'Rare', defense: 3, evasion: 4, criticalChance: 2, description: 'For those who brave the wilderness.', icon: '/icons/item-cap.svg', allowedClasses: ['ranger']},
    ...
    'ranger_helmet_epic_balanced': { name: 'Sentry\'s Coif', type: 'helmet', rarity: 'Epic', defense: 5, evasion: 7, criticalChance: 4, attack: 2, description: 'The watchful eye of the forest.', icon: '/icons/item-cap.svg', allowedClasses: ['ranger']},
    ...
    'ranger_helmet_legendary_balanced': { name: 'Gryphon-Feather Cap', type: 'helmet', rarity: 'Legendary', defense: 8, evasion: 10, criticalChance: 8, attack: 5, description: 'As light and sharp as the wind.', icon: '/icons/item-cap.svg', allowedClasses: ['ranger']},
    ...
    'assassin_helmet_rare_balanced': { name: 'Thief\'s Cowl', type: 'helmet', rarity: 'Rare', defense: 2, evasion: 5, criticalChance: 4, description: 'A staple of the underworld.', icon: '/icons/item-hood.svg', allowedClasses: ['assassin']},
    ...
    'assassin_helmet_epic_balanced': { name: 'Cowl of the Silent Killer', type: 'helmet', rarity: 'Epic', defense: 4, evasion: 8, criticalChance: 8, attack: 2, description: 'Death comes without a sound.', icon: '/icons/item-hood.svg', allowedClasses: ['assassin']},
    ...
    'assassin_helmet_legendary_balanced': { name: 'Mask of the Betrayer', type: 'helmet', rarity: 'Legendary', defense: 7, evasion: 12, criticalChance: 15, attack: 7, description: 'A friendly face that hides a deadly secret.', icon: '/icons/item-hood.svg', allowedClasses: ['assassin']},
    ...
    'warrior_belt_epic_balanced': { name: 'Belt of the Warlord', type: 'belt', rarity: 'Epic', defense: 4, armor: 6, attack: 3, description: 'A commander\'s belt.', icon: '/icons/item-belt.svg', allowedClasses: ['warrior']},
    ...
    'warrior_belt_legendary_offensive': { name: 'Belt of Unstoppable Carnage', type: 'belt', rarity: 'Legendary', defense: 4, armor: 5, attack: 8, criticalChance: 4, description: 'Leave only destruction in your wake.', icon: '/icons/item-belt.svg', allowedClasses: ['warrior']},
    ...
    'mage_belt_epic_balanced': { name: 'Archon\'s Sash', type: 'belt', rarity: 'Epic', defense: 3, magicResist: 6, magicAttack: 5, description: 'A symbol of high-level mastery.', icon: '/icons/item-sash.svg', allowedClasses: ['mage']},
    ...
    'mage_belt_legendary_balanced': { name: 'Sash of Cosmic Balance', type: 'belt', rarity: 'Legendary', defense: 5, magicResist: 10, magicAttack: 8, criticalChance: 4, description: 'Aligns the stars in your favor.', icon: '/icons/item-sash.svg', allowedClasses: ['mage']},
    ...
    'ranger_belt_rare_balanced': { name: 'Explorer\'s Belt', type: 'belt', rarity: 'Rare', defense: 2, evasion: 3, criticalChance: 1, description: 'Has a tool for every situation.', icon: '/icons/item-belt.svg', allowedClasses: ['ranger']},
    ...
    'ranger_belt_epic_balanced': { name: 'Wilderness Survival Belt', type: 'belt', rarity: 'Epic', defense: 3, evasion: 5, criticalChance: 3, attack: 2, description: 'Everything you need to survive the wilds.', icon: '/icons/item-belt.svg', allowedClasses: ['ranger']},
    ...
    'ranger_belt_legendary_balanced': { name: 'Horizon-Walker\'s Belt', type: 'belt', rarity: 'Legendary', defense: 5, evasion: 8, criticalChance: 6, attack: 6, description: 'For those who have seen it all.', icon: '/icons/item-belt.svg', allowedClasses: ['ranger']},
    'ranger_belt_legendary_offensive': { name: 'Wind-Chaser\'s Sash', type: 'belt', rarity: 'Legendary', defense: 3, evasion: 6, criticalChance: 10, attack: 8, description: 'You are as fast and deadly as the wind.', icon: '/icons/item-belt.svg', allowedClasses: ['ranger']},
    ...
    'assassin_belt_rare_balanced': { name: 'Thief\'s Toolbelt', type: 'belt', rarity: 'Rare', defense: 1, evasion: 3, criticalChance: 3, description: 'Lockpicks, smoke bombs, and more.', icon: '/icons/item-bandolier.svg', allowedClasses: ['assassin']},
    ...
    'assassin_belt_epic_balanced': { name: 'Guildmaster\'s Sash', type: 'belt', rarity: 'Epic', defense: 3, evasion: 6, criticalChance: 6, attack: 2, description: 'A mark of high rank in the shadows.', icon: '/icons/item-bandolier.svg', allowedClasses: ['assassin']},
